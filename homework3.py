...
# Train the model
model.fit(X_train, encoded_y_train, epochs=10, batch_size=32, validation_split=0.2)
...
keras_estimator = KerasClassifier(build_fn=create_model, epochs=5, batch_size=32, verbose=0)
